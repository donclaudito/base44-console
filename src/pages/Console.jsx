...
export default function Console() {
  ...
  const deleteSiteMutation = useMutation({
    ...
    onSuccess: (_, deletedId) => {
      // Clear active site immediately if it was the deleted one
  ...
  return (
    <div className="h-screen w-full flex bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-200 overflow-hidden font-sans">
      {/* Mobile Overlay */}
      {isSidebarOpen && (
        <div
