      ...
      <div className="flex items-center gap-4 lg:gap-6">
        <div className="flex flex-col">
          ...
          <div className="flex items-center gap-2 mt-0.5">
            ...
            <span className="text-[9px] text-slate-500 font-bold uppercase tracking-[0.2em] italic">
              Terminal Ativo
            </span>
          </div>
        </div>
        ...
        {activeSite && view === 'workspace' && (
          <>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex items-center gap-2 bg-white text-slate-950 px-5 lg:px-6 py-2.5 lg:py-3 rounded-2xl font-black text-[10px] hover:bg-blue-50 transition-all shadow-2xl active:scale-95"
            >
